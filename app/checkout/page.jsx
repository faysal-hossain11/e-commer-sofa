...
const checkoutPage = () => {
    return (
        <div>
            ...
            {/* start the checkout page contant */}
            <div class="container mx-auto grid grid-cols-12 items-start pb-16 pt-4 gap-6">
                ...
                <div class="col-span-4 border border-gray-200 p-4 rounded">
                    ...
                    <div class="flex items-center mb-4 mt-2">
                        ...
                        <label for="aggrement" class="text-gray-600 ml-3 cursor-pointer text-sm">I agree to the <Link href="#"
