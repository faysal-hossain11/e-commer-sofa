    ...
    return (
        <>
            ...
            <div className="container mx-auto grid grid-cols-2 gap-6">
                <div>
                    ...
                    <div className="grid grid-cols-5 gap-4 mt-4">
                        ...
                        <Image src={Product6} alt="product2" className="w-full cursor-pointer border" />
                    </div>
                </div>

                <div>
                    <h2 className="text-3xl font-semibold uppercase mb-2">Italian L Shape Sofa</h2>
            ...
            <div className="container mx-auto pb-16 mt-10">
                <h3 className="border-b border-gray-200 font-roboto text-gray-800 pb-3 font-semibold text-2xl">Product details</h3>
